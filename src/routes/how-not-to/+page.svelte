...
h2 how to make struts from sticks...
h4 craft, that is..

p 
	| What you will need to get started: sticks, glue, and 36 degrees
...
ul
	...
	li    *Hot Melt Glue:* Gooey, hard to keep in place during cooling, and prone to lots of spludges and spider webs.
	li      *Most glues for paper:* The old standby had no 'tack' during assembly.  parts would slde apart too easily.

h3
	em Some things that did seem to work:
ul
	li *full size 6 inch sticks:* Round corners help assure the circle of contact is exact. the thickness is reduced compared to the neighbooring struts so misalignment is reduced.
	li  *Depending on angles rather than exact lengths:*  This one was rather surprising, since western tooling has been most excellent at getting length measurements down to the tiniest possible.  It seens that errors in the placement would add up as an assembly was put together, causing it to not quite fit.  When we switched to simply depending on the sticks themselves to have a consistent length, we shifted to making as perfect angle of 36 degrees with two sticks.  The result?  any errors in the angle of these guys would tent to averge out over a larger structure.  The result always got the point across.


h3  __Some Things That Still Need Improving:__
ul
	li 	_hinges:_ Most office tape sticks too much or doesn't stretch.  Duct tape is too wide and makes a mess to work with.  Maybe something with balloon animal balloons.
	li  _hook and loop tapes:_ Finding the right amount of hold versus removability is the key.  By repeated application/removal, the question remains: How many times can I do this before the whole thing falls apart.  After all, it's not welded rebar, it's just craft sticks and easy peasy glue.
