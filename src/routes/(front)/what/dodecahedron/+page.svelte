...
<template lang="pug" >
<Card image="/src/lib/space-struts/IMG_2447.jpeg" heading="A Dodecahedron" >
...
p The golden triangles are forced to participate in all the verticies of a dodecahedron made from huts.

p other variants have three Gnomons at six corners.
</Card>
</template>
