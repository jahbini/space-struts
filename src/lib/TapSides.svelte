<script >
  ...
  <div class="tapSides" bind:this={ref}>
    <div class="tapTarget backward" on:click={onSeekBackward} on:keyup={onSeekBackward} />
    <div class="spacer" />
    <div class="tapTarget forward" on:click={onSeekForward} on:keyup={onSeekForward} />
  </div>
